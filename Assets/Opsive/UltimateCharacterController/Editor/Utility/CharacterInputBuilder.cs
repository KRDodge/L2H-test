...
namespace Opsive.UltimateCharacterController.Editor.Utility
{
    ...
    public class CharacterInputBuilder
    {
        ...
        public static void UpdateInputManager()
        {
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Mouse X", "", "", "", "", 0, 0.19f, 1, false, false, UnityInputBuilder.AxisType.Joystick, UnityInputBuilder.AxisNumber.Four);
            UnityInputBuilder.AddInputAxis(axisProperty, "Mouse Y", "", "", "", "", 0, 0.19f, 1, false, true, UnityInputBuilder.AxisType.Joystick, UnityInputBuilder.AxisNumber.Five);
