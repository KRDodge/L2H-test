...
namespace Opsive.UltimateCharacterController.Inventory
{
    ...
    public abstract class InventoryBase : MonoBehaviour
    {
        ...
        public virtual void RemoveItem(IItemIdentifier itemIdentifier, int slotID, int amount, bool drop)
        {
            var item = GetItem(itemIdentifier, slotID);
        ...
        public virtual void DropItem(Item item, int amount, bool forceDrop, bool remove)
        {
            ...
            if (item.DropPrefab != null) {
                ...
                if (m_NetworkInfo == null || m_NetworkInfo.IsServer()) {
                    ...
                    if (existingAmount > 0 || forceDrop) {
                        ...
                        var spawnedObject = ObjectPoolBase.Instantiate(item.DropPrefab, dropPosition, dropRotation);
