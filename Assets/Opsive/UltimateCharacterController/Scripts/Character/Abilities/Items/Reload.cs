...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class Reload : ItemAbility
    {
            ...
            for (int i = 0; i < m_ReloadableItems.Length; ++i) {
                if (m_ReloadableItems[i] != null) {
                    ...
                    if (!m_ReloadableItems[i].ReloadEvent.WaitForAnimationEvent) {
                        m_ReloadEvents[i] = SchedulerBase.ScheduleFixed(m_ReloadableItems[i].ReloadEvent.Duration, ReloadItem, i);
                    }
                }
            }
        }
        ...
        {
            for (int i = 0; i < m_ReloadableItems.Length; ++i) {
                if (m_ReloadableItems[i] != null && !m_Reloaded[i] && !m_ReloadableItems[i].ReloadEvent.WaitForSlotEvent) {
                    ReloadItem(i);
                }
            }
        }
        ...
        {
            if (m_ReloadableItems[0] == null || !m_ReloadableItems[0].ReloadEvent.WaitForSlotEvent || m_ReloadableItems[0].Item.SlotID != 0) {
                return;
            }
            ReloadItem(0);
        }
        ...
        private void OnItemReloadSecondSlot()
        {
            ...
            if (m_ReloadableItems[index] == null || !m_ReloadableItems[index].ReloadEvent.WaitForSlotEvent || m_ReloadableItems[index].Item.SlotID != 1) {
                return;
            }
            ReloadItem(index);
        }
        ...
        private void OnItemReloadThirdSlot()
        {
            ...
            if (m_ReloadableItems[index] == null || !m_ReloadableItems[index].ReloadEvent.WaitForSlotEvent || m_ReloadableItems[index].Item.SlotID != 2) {
                return;
            }
            ReloadItem(index);
        }
        ...
        private void ReloadItem(int slotID)
        {
            ...
            if (canReload && reloadableItem.CanReloadItem(true)) {
                ...
                if (!reloadableItem.ReloadEvent.WaitForAnimationEvent) {
                    m_ReloadEvents[slotID] = SchedulerBase.ScheduleFixed(reloadableItem.ReloadEvent.Duration, ReloadItem, slotID);
                }
            } else {
                ...
                if (!reloadableItem.ReloadCompleteEvent.WaitForAnimationEvent) {
                    m_ReloadEvents[slotID] = SchedulerBase.ScheduleFixed(reloadableItem.ReloadCompleteEvent.Duration, ReloadItemComplete, slotID);
                }
            }
        }
        ...
        {
            for (int i = 0; i < m_ReloadableItems.Length; ++i) {
                if (m_ReloadableItems[i] != null && !m_ReloadableItems[i].ReloadCompleteEvent.WaitForSlotEvent) {
        ...
        {
            if (m_ReloadableItems[0] == null || !m_ReloadableItems[0].ReloadCompleteEvent.WaitForSlotEvent || m_ReloadableItems[0].Item.SlotID != 0) {
                return;
            }
        ...
        {
            var index = m_SlotID == -1 ? 1 : 0;
            if (m_ReloadableItems[index] == null || !m_ReloadableItems[index].ReloadCompleteEvent.WaitForSlotEvent || m_ReloadableItems[index].Item.SlotID != 1) {
                return;
            }
        ...
        {
            var index = m_SlotID == -1 ? 2 : 0;
            if (m_ReloadableItems[index] == null || !m_ReloadableItems[index].ReloadCompleteEvent.WaitForSlotEvent || m_ReloadableItems[index].Item.SlotID != 2) {
                return;
            }
            ReloadItemComplete(index);
        }
